...
import { AWS_S3_ACCESS_KEY_ID, AWS_S3_BUCKET, AWS_S3_SECRET_ACCESS_KEY } from '../../../env';
...
export const useS3Client = () => {
  ...
  const uploadPublicImage = useCallback((side: Side, data: string) =>
    s3Client.current.putObject({
  ...
  const uploadJsonFile = useCallback((name: string, data: Object, ACL = 'private') =>
    s3Client.current.putObject({
      Bucket: AWS_S3_BUCKET,
